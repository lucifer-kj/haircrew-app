...
export default async function DashboardPage(props: DashboardPageProps) {
  ...
  try {
    ...
    const topProductsRes = await fetch('/api/admin/top-products', { cache: 'no-store' })
    ...
    return (
      <div className="p-8 text-red-600">An error occurred while loading the dashboard. Please try again later.</div>
    )
  }
} 