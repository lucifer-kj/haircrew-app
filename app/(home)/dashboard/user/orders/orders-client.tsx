...
function OrderStatusBadge({ status }: { status: string }) {
  ...
  return <GlassBadge variant={getVariant(status)}>{status}</GlassBadge>
}
...
export default function OrdersClient({ orders }: OrdersClientProps) {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(248,247,255,1) 0%, rgba(250,247,254,1) 35%, rgba(245,251,255,1) 100%)',
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        {orders.length === 0 ? (
          <GlassCard className="p-12 text-center">
            ...
            <Link
              href="/products"
              className="mt-6 inline-flex items-center text-primary font-medium"
            >
              Browse Products
