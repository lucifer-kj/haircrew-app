    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12">
        ...
        <div className="flex-1 p-8 bg-white rounded-l-xl">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs mt-1 font-medium text-gray-400">Confirmation</span>
              </div>
            </div>
          </div>
          ...
          {step === "review" && (
            <form onSubmit={e => {
              ...
              <Button type="submit" className="w-full bg-orange-500 hover:bg-orange-600 text-white text-base font-semibold py-3 rounded-md shadow-md">
                {isPlacing ? "Processing..." : paymentMethod === "COD" ? "Place Order" : "Proceed to Payment"}
              </Button>
            </form>
          )}
          {/* UPI Payment Step */}
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <Dialog.Content className="max-w-md mx-auto text-center p-8">
          <Dialog.Title className="text-2xl font-bold text-green-600 mb-2">Order Placed!</Dialog.Title>
          ...
          <div className="bg-gray-50 rounded p-4 mb-4 text-left inline-block w-full max-w-xs mx-auto">
            <div><b>Order #:</b> {modalOrderId}</div>
          </div>
          <div className="text-gray-500 text-sm mb-2">You will be redirected to your order confirmation shortly...</div>
          <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-md shadow-md mt-2" onClick={() => router.push(`/order-received/${modalOrderId}`)}>
