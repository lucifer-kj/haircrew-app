...
function HeroCarousel() {
  ...
  const { parent: featuresParent, child: featuresChild } =
          ...
          >
            ...
            <motion.div variants={reduced ? undefined : featuresChild}>
              <Link
                ...
                prefetch={true}
                className="h-full w-full rounded-xl shadow-md flex flex-col justify-end p-0 overflow-hidden group relative"
                style={{ minHeight: 0 }}
              >
                <Image
                ...
                <div className="relative z-10 flex flex-col justify-end h-full w-full pl-8 pb-8">
                  <h3 className="text-2xl font-extrabold font-headings text-white mb-2 text-left">
                    Shampoo
                  </h3>
                  <p className="text-lg font-semibold text-white text-left max-w-xs">
                    Cleansing and nourishing formulas for all hair types.
                  </p>
                </div>
              </Link>
            </motion.div>
            ...
            <motion.div variants={reduced ? undefined : featuresChild}>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-end h-full w-full pl-8 pb-8">
                  ...
                  <p className="text-lg font-semibold text-white text-left max-w-xs">
                    Hydrating and smoothing conditioners for silky hair.
                  </p>
                </div>
              </Link>
            </motion.div>
            ...
            <motion.div variants={reduced ? undefined : featuresChild}>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-end h-full w-full pl-8 pb-8">
                  ...
                  <p className="text-lg font-semibold text-white text-left max-w-xs">
                    Repair and restore with intensive treatments.
                  </p>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--dark-gray)] max-w-2xl mx-auto">
              Explore our comprehensive range of hair care products organized by
              category
            </p>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[var(--dark-gray)]">
                    Professional shampoos for all hair types
                  </p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[var(--dark-gray)]">
                    Specialized treatments for hair repair
                  </p>
                </div>
              </div>
            </Link>
